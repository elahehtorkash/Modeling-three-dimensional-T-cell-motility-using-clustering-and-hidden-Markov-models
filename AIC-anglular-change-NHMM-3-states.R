...
parameter.bayes<-cbind(prior_pi[1], prior_pi[2], prior_pi[3], P_1[1, 1], P_1[1, 2], P_1[1, 3], P_1[2, 1], P_1[2, 2], P_1[2, 3], P_1[3, 1], P_1[3, 2], P_1[3, 3], P_2[1, 1], P_2[1, 2], P_2[1, 3], P_2[2, 1], P_2[2, 2], P_2[2, 3], P_2[3, 1], P_2[3, 2], P_2[3, 3], alpha_persistent, beta_persistent, alpha_non_persistent, beta_non_persistent, alpha_transition, beta_transition)
