...
setwd("/sbb/scratch/torkashe/Spherical-Coordinates-Motility-Metrics/Straightness/")
...
plot(x.lab, M.G.D.straightness, col="black", xaxt = "n", xlab="Step", ylab="Straightness", main="",   ylim=c(min(M.G.D.straightness+ data.sd.fence.straightness.track[3: time.msd]/sqrt(counter.time.data[3: time.msd]))-.1, max(M.G.D.straightness+ data.sd.fence.straightness.track[3: time.msd]/sqrt(counter.time.data[3: time.msd]))+.1),  pch=24, cex.lab=2, cex.main=2.5, type="l", cex=1.5, lwd=1.5)

axis(1, at= x.lab, labels= x.lab)


arrows(x.lab, M.G.D.straightness-data.sd.fence.straightness.track[3: time.msd]/sqrt(counter.time.data[3: time.msd]), x.lab, M.G.D.straightness+ data.sd.fence.straightness.track[3: time.msd]/sqrt(counter.time.data[3: time.msd]), length=0.05, angle=90, code=3, col="black")
...
points(x.lab, M.G.D.straightness, col="black", lty=6, lwd=1.5, pch=20, type="l", cex=1.5)
...
dev.print(pdf, 'Rplot-Straightness.pdf', width=10, height=6, paper='special')


dev.copy(jpeg, filename="Rplot-Straightness.jpeg");
