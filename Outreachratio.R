...
setwd("/sbb/scratch/torkashe/Spherical-Coordinates-Motility-Metrics/Outreach-ratio/")
...
plot(x.lab, M.G.D.outreachratio, col="black", xaxt = "n", xlab="Step", ylab="Outreach Ratio", main="",   ylim=c(min(M.G.D.outreachratio+ data.sd.fence.outreachRatio.track[3: time.msd]/sqrt(counter.time.data[3: time.msd]))-.1, max(M.G.D.outreachratio+ data.sd.fence.outreachRatio.track[3: time.msd]/sqrt(counter.time.data[3: time.msd]))+.1),  pch=24, cex.lab=2, cex.main=2.5, type="l", cex=1.5, lwd=1.5)

axis(1, at= x.lab, labels= x.lab)


arrows(x.lab, M.G.D.outreachratio-data.sd.fence.outreachRatio.track[3: time.msd]/sqrt(counter.time.data[3: time.msd]), x.lab, M.G.D.outreachratio+ data.sd.fence.outreachRatio.track[3: time.msd]/sqrt(counter.time.data[3: time.msd]), length=0.05, angle=90, code=3, col="black")
...
points(x.lab, M.G.S.straightness, col="darkred", pch=20, type="l", cex=1.5, lwd=1.5)
...
points(x.lab, M.G.S.straightness, col="darkred", pch=11, type="l", cex=1.5, lwd=1.5, lty=3)
...
points(x.lab, M.G.S.straightness, col="yellow", pch=20, type="l", cex=1.5, lwd=1.5)
...
points(x.lab, M.G.S.straightness, col="yellow", pch=11, type="l", cex=1.5, lwd=1.5)
...
points(x.lab, M.G.S.straightness, col="cyan", pch=20, type="l", cex=1.5, lwd=1.5)
...
points(x.lab, M.G.S.straightness, col="cyan", pch=11, type="l", cex=1.5, lwd=1.5, lty=3)
...
points(x.lab, M.G.D.outreachratio, col="black", lty=6, lwd=1.5, pch=20, type="l", cex=1.5)
...
points(x.lab, M.G.S.straightness, col="darkblue", pch=20, type="l", cex=1.5, lwd=1.5, lty=4)
...
points(x.lab, M.G.S.straightness, col="black", pch=18, type="l", cex=1.5, lwd=1.5)
...
dev.print(pdf, 'Rplot-outreach-ratio.pdf', width=10, height=6, paper='special')


dev.copy(jpeg, filename="Rplot-outreach-ratio.jpeg");
