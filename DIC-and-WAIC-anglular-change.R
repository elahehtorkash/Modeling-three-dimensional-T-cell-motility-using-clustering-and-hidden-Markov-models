...
parameter.fit.angle<-cbind(prior_pi, P_1[, 1, 1], P_1[, 1, 2], P_1[, 2, 1], P_1[, 2, 2], alpha_per, beta_per, alpha_non_per, beta_non_per, counter.c)
...
parameter.fit.angle<-cbind(prior_pi, P_1[, 1, 1], P_1[, 1, 2], P_1[, 2, 1], P_1[, 2, 2], alpha_per, beta_per, alpha_non_per, beta_non_per)
