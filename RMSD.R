...
setwd("/global/scratch/torkashe/Clustering-Results/measures-of-motility-2-clusters-ET-2-states-HHMM/")
...
M.G.D.hurst<-measure.greg.hurst.data[2: time.msd]/counter.time.data[2: time.msd]
...
setwd("/global/scratch/torkashe/Spherical-Coordinates-Motility-Metrics/RMSD/")
...
ylab.values<-c(seq(0, 4, 1), seq(5, 30, 5), 40)


xlab<-seq(1, (time.msd-1), 1)


xlab.values<-log(xlab)/log(10)


plot(xlab, sqrt(M.G.D.squared.displacement), col="black", xaxt = "n", xlab="Step", ylab="RMSD", main=" ", ylim=c(0,max(sqrt(M.G.D.squared.displacement))+1),  pch=16, cex.lab=2, cex.main=2.5, type="b", cex=1.5, lwd=1.5)

axis(1, at= xlab, labels= xlab)


# # # # arrows(xlab, sqrt(M.G.D.squared.displacement)-data.sd.fence.squareDisplacement.track[2: time.msd]/sqrt(counter.time.data[2: time.msd]), xlab, sqrt(M.G.D.squared.displacement) + data.sd.fence.squareDisplacement.track[2: time.msd]/sqrt(counter.time.data[2: time.msd]), length=0.05, angle=90, code=3, col="black")

axis(2, at= ylab.values, labels= ylab.values)
...
##########################################################################################################################    
  ...
  setwd("/global/scratch/torkashe/Clustering-Results/measures-of-motility-4-clusters-ET-2-states-NHMM")
...
M.G.S.hurst<-measure.greg.hurst.simulated[2: time.msd]/counter.time.simulated[2: time.msd]
...
x.lab <-seq(1, (time.msd-1), 1)

xlab.values<-log(x.lab)/log(10)

# points(M.G.S.max.diplacement.ratio, col="violetred", pch=20, type="p")

points(x.lab, sqrt(M.G.S.squared.diplacement), col="darkred", pch=20, type="l", cex=1.5, lwd=1.5)
...
##########################################################################################################################    
  ...
  setwd("/global/scratch/torkashe/Clustering-Results/no-clustering-spherical-modeling-NHMM")
...
points(x.lab, sqrt(M.G.S.squared.diplacement), col="darkblue", pch=20, type="l", cex=1.5, lwd=1.5, lty=4)
...
##########################################################################################################################    
  ...
  setwd("/global/scratch/torkashe/Clustering-Results/measures-of-motility-2-clusters-ET-2-states-NHMM")
...
points(x.lab, sqrt(M.G.S.squared.diplacement), col="darkred", pch=11, type="l", cex=1.5, lwd=1.5, lty=3)
...
##########################################################################################################################    
  ...
  setwd("/global/scratch/torkashe/Clustering-Results/measures-of-motility-3-clusters-mokh-2-states-NHMM/")
...
points(x.lab, sqrt(M.G.S.squared.diplacement), col="yellow", pch=20, type="l", cex=1.5, lwd=1.5)
...
##########################################################################################################################    
  ...
  setwd("/global/scratch/torkashe/Clustering-Results/measures-of-motility-4-clusters-spectral-2-states-NHMM/")
...
points(x.lab, sqrt(M.G.S.squared.diplacement), col="cyan", pch=20, type="l", cex=1.5, lwd=1.5)
...
##########################################################################################################################    
  ...
  setwd("/global/scratch/torkashe/Clustering-Results/measures-of-motility-2-clusters-spectral-2-states-NHMM/")
...
points(x.lab, sqrt(M.G.S.squared.diplacement), col="cyan", pch=11, type="l", cex=1.5, lwd=1.5, lty=3)
...
points(x.lab, sqrt(M.G.S.squared.diplacement), col="black", lty=6, lwd=1.5, pch=20, type="l", cex=1.5)



setwd("/global/scratch/torkashe/Spherical-Coordinates-Motility-Metrics/RMSD/")

dev.print(pdf, 'Rplot-RMSD.pdf', width=10, height=6, paper='special')


dev.copy(jpeg, filename="Rplot-RMSD.jpeg");
